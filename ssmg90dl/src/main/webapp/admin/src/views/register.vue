  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">房屋租赁管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='zhongjie'" class="input-group">
			   <div class="label">中介账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhongjiezhanghao" class="input" type="text" placeholder="中介账号">
			   </div>
			 </div> -->
			<el-form-item label="中介账号" class="input" v-if="tableName=='zhongjie'">
			  <el-input v-model="ruleForm.zhongjiezhanghao" autocomplete="off" placeholder="中介账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongjie'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhongjie'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongjie'" class="input-group">
			   <div class="label">中介姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhongjiexingming" class="input" type="text" placeholder="中介姓名">
			   </div>
			 </div> -->
			<el-form-item label="中介姓名" class="input" v-if="tableName=='zhongjie'">
			  <el-input v-model="ruleForm.zhongjiexingming" autocomplete="off" placeholder="中介姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongjie'" class="input-group">
			   <div class="label">身份证</div>
			   <div class="input-container">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='zhongjie'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongjie'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='zhongjie'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='zhongjie'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
