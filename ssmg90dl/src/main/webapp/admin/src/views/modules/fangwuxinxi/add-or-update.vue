  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fangwuhao" label="房屋号" prop="fangwuhao">
              <el-input v-model="ruleForm.fangwuhao" 
                placeholder="房屋号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="中介账号" prop="zhongjiezhanghao">
          <el-input v-model="ruleForm.zhongjiezhanghao" 
              placeholder="中介账号" clearable  :readonly="ro.zhongjiezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="中介账号" prop="zhongjiezhanghao">
              <el-input v-model="ruleForm.zhongjiezhanghao" 
                placeholder="中介账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="中介姓名" prop="zhongjiexingming">
          <el-input v-model="ruleForm.zhongjiexingming" 
              placeholder="中介姓名" clearable  :readonly="ro.zhongjiexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="中介姓名" prop="zhongjiexingming">
              <el-input v-model="ruleForm.zhongjiexingming" 
                placeholder="中介姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	zhuangtai : false,
	xiangqing : false,
	zhongjiezhanghao : false,
	zhongjiexingming : false,
	lianxidianhua : false,
      },
      ruleForm: {
        fangwuhao: this.getUUID(),
        fangwumingcheng: '',
        fangwuleixing: '',
        tupian: '',
        mianji: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangqing = true;
          ...
          if(o=='zhongjiezhanghao'){
            this.ruleForm.zhongjiezhanghao = obj[o];
	    this.ro.zhongjiezhanghao = true;
            continue;
          }
          if(o=='zhongjiexingming'){
            this.ruleForm.zhongjiexingming = obj[o];
	    this.ro.zhongjiexingming = true;
            continue;
          }
          if(o=='lianxidianhua'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhongjiezhanghao!=''&&json.zhongjiezhanghao){
              		this.ruleForm.zhongjiezhanghao = json.zhongjiezhanghao
		}
		if(json.zhongjiexingming!=''&&json.zhongjiexingming){
              		this.ruleForm.zhongjiexingming = json.zhongjiexingming
		}
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmg90dl/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
