<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房屋号" prop="fangwuhao">
          <el-input v-model="ruleForm.fangwuhao" 
              placeholder="房屋号" clearable  :readonly="ro.fangwuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房屋号" prop="fangwuhao">
              <el-input v-model="ruleForm.fangwuhao" 
                placeholder="房屋号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="水电费" prop="shuidianfei">
          <el-input v-model="ruleForm.shuidianfei" 
              placeholder="水电费" clearable  :readonly="ro.shuidianfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="水电费" prop="shuidianfei">
              <el-input v-model="ruleForm.shuidianfei" 
                placeholder="水电费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物业费" prop="wuyefei">
          <el-input v-model="ruleForm.wuyefei" 
              placeholder="物业费" clearable  :readonly="ro.wuyefei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物业费" prop="wuyefei">
              <el-input v-model="ruleForm.wuyefei" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房租费" prop="fangzufei">
          <el-input v-model="ruleForm.fangzufei" 
              placeholder="房租费" clearable  :readonly="ro.fangzufei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房租费" prop="fangzufei">
              <el-input v-model="ruleForm.fangzufei" 
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="账单详情" prop="zhangdanxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhangdanxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhangdanxiangqing" label="账单详情" prop="zhangdanxiangqing">
                    <span v-html="ruleForm.zhangdanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='shuidianfei'){
            this.ruleForm.shuidianfei = obj[o];
	    this.ro.shuidianfei = true;
            continue;
          }
          if(o=='wuyefei'){
	    ...
	    this.ro.wuyefei = true;
          ...
          if(o=='fangzufei'){
            this.ruleForm.fangzufei = obj[o];
	    this.ro.fangzufei = true;
            continue;
          }
          if(o=='zhangdanxiangqing'){
            this.ruleForm.zhangdanxiangqing = obj[o];
	    this.ro.zhangdanxiangqing = true;
            continue;
          }
          if(o=='userid'){
	...
	this.ruleForm.zhangdanxiangqing = this.ruleForm.zhangdanxiangqing.replace(reg,'../../../ssmg90dl/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zufangzhangdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zufangzhangdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
